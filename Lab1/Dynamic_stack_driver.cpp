/****************************************************
 * Class:   Dynamic_stack_driver
 * Author:  Douglas Wilhelm Harder
 * Copyright (c) 2006-14 by Douglas Wilhelm Harder.  All rights reserved.
 *
 * DO NOT EDIT THIS FILE
 *
 * Create an instance of the Dynamic_stack_tester<int>
 * or Dynamic_stack_tester<double> classes and call
...
#include <iostream>
#include <cstring>
#include "Dynamic_stack_tester.h"

int main( int argc, char *argv[] ) {
	Dynamic_stack_tester tester;
